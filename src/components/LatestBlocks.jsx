              ...
              <div className="block-individ" key={getBlocks.indexOf(block)}>
                <div className="block-number">
                  <div className="block-number-main">
                    <Link className="block-link" to={`block/${block.number}`}>
                      {block.number}
                    </Link>
                  </div>
                ...
                <div className="block-miner">
                  ...
                  <div className="block-miner-main">
                    <Link
                      className="block-link"
                      to={`${ethNetwork}/address/${block.miner}`}
                    >
                      {block.miner}
                    </Link>
                  </div>
                ...
                <div className="block-transactions">
                  {block.transactions.length === 1 ? (
                    <>{block.transactions.length} txn completed 💸💸 </>
                  ) : (
                    <>{block.transactions.length} txns completed 💸💸</>
                  )}
                </div>
              </div>
            );
